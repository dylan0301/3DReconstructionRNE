...
def findNormal(AllPoints, BoundaryPoints, CenterPoints, hyperparameter):
    ...
    for p in AllPoints.values():
        BoundaryPoints, CenterPoints, BoundaryError, CenterError = normalVectorizeRansacScore(p, BoundaryPoints, CenterPoints, hyperparameter, BoundaryError, CenterError)
    print('BoundaryError')
